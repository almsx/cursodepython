...
p_ye = raw_input("Ingrese el Anio de Nacimiento ")
p_mo = raw_input("Ingrese el Mes ")
p_da = raw_input("Ingrese el Dia ")
...
#Incluir validacion de las vocales
vocal = ""
for char in p_ap:
...
if p_ye.isdigit():
    ...
    print("El anio debe ser solo digitos")
    p_f_ye = "00"
...
if p_mo.isdigit():
    ...
    print("El mes debe ser solo digitos")
    p_f_mo = "00"
...
if p_da.isdigit():
    ...
    print("El dia debe ser solo digitos")
    p_f_da = "00"
